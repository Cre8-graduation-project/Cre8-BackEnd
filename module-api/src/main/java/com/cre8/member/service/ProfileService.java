package com.cre8.member.service;


import com.cre8.event.s3.S3UploadImageCommitEvent;
import com.cre8.event.s3.S3UploadImageRollbackEvent;
import com.cre8.member.dto.PasswordChangeAfterTMPRequestDto;
import com.cre8.member.dto.PasswordChangeRequestDto;
import com.cre8.member.dto.ProfileWithUserInfoEditRequestDto;
import com.cre8.member.dto.ProfileWithUserInfoResponseDto;
...
public class ProfileService {
    ...
    private String getAccessUrlWithSettingEvent(MultipartFile multipartFile,Member member){
        ...
        eventPublisher.publishEvent(
                S3UploadImageCommitEvent.builder().oldAccessImageUrl(member.getAccessUrl()).build());
