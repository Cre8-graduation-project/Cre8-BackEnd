package com.cre8.auth.config;


import com.cre8.auth.handler.JwtAccessDeniedHandler;
import com.cre8.auth.handler.JwtAuthenticationEntryPointHandler;
import com.cre8.auth.jwt.JwtFilter;
                ...
                .authorizeHttpRequests((requests) ->
                        requests
                                ...
                                .requestMatchers(HttpMethod.POST,"/api/v1/community/boards","/api/v1/tags","/api/v1/tags/category","/api/v1/tags/categories",
                                        "/api/v1/tags/child","/api/v1/tags/childs").hasAuthority(
                                        Authority.MANAGER.toString())
