...
import com.cre8.employmentpost.controller.EmployerPostController;
import com.cre8.employmentpost.dto.request.EditEmployerPostRequestDto;
import com.cre8.employmentpost.dto.request.SaveEmployerPostRequestDto;
import com.cre8.employmentpost.dto.response.EmployerPostResponseDto;
...
import com.cre8.employmentpost.service.EmployerPostCRUDService;
...
class EmployerPostControllerTest {
    ...
    void 구직자_게시글_단건조회() throws Exception{
        ...
        given(employerPostCRUDService.showEmployerPost(anyLong(),anyString())).willReturn(
                EmployerPostResponseDto.of(subCategoryWithChildTagResponseDtoList,employerPost,false));
