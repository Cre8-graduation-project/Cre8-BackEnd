...
import com.gaduationproject.cre8.app.portfolio.controller.PortfolioController;
...
class EmployeePostControllerTest {
    ...
    void 구직자_게시글_단건조회() throws Exception{
        ...
        given(employeePostCRUDService.showEmployeePost(anyLong())).willReturn(
                EmployeePostResponseDto.of(subCategoryWithChildTagResponseDtoList,employeePost,portfolioSimpleResponseDtoList));
