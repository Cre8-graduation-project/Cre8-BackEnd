...
public class EmployeePostSearchController {
    ...
    public ResponseEntity<BaseResponse<TestEmployeePostSearchWithCountResponseDto>> employeePostSearchResponse2(final EmployeePostSearch employeePostSearch,
            @PageableDefault(size = 10,sort = "createdAt",direction = Direction.DESC,page = 0) final Pageable pageable){

        return ResponseEntity.ok(BaseResponse.createSuccess(employeePostSearchService.searchEmployeePostTest(employeePostSearch,pageable)));
    }

    @GetMapping("/test2")
    @Operation(summary = "구직자 게시글 검색3",description = "구직자 게시글을 다양한 조건으로 검색할 수 있습니다.3")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",description = "구직자 게시글 성공적 검색")
    })
    @Parameters({
    ...
    public ResponseEntity<BaseResponse<TestEmployeePostSearchWithCountResponseDto>> employeePostSearchResponse3(final EmployeePostSearch employeePostSearch,
            @PageableDefault(size = 10,sort = "createdAt",direction = Direction.DESC,page = 0) final Pageable pageable){

        return ResponseEntity.ok(BaseResponse.createSuccess(employeePostSearchService.searchEmployeePostTest2(employeePostSearch,pageable)));
    }

    @GetMapping("/test3")
    @Operation(summary = "구직자 게시글 검색4",description = "구직자 게시글을 다양한 조건으로 검색할 수 있습니다.4")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",description = "구직자 게시글 성공적 검색")
    })
    @Parameters({
    ...
    public ResponseEntity<BaseResponse<TestEmployeePostSearchWithCountResponseDto>> employeePostSearchResponse4(final EmployeePostSearch employeePostSearch,
            @PageableDefault(size = 10,sort = "createdAt",direction = Direction.DESC,page = 0) final Pageable pageable){

        return ResponseEntity.ok(BaseResponse.createSuccess(employeePostSearchService.searchEmployeePostTest3(employeePostSearch,pageable)));
    }
