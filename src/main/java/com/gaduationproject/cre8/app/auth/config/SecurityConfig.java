                ...
                .authorizeHttpRequests((requests) ->
                        requests
                                ...
                                ,"/api/v1/employee-posts/search","/api/v1/employer/posts/*","/api/v1/employer-posts/search","/api/v1/members/check",
                                        ...
                                        "/api/v1/community/boards","/api/v1/community/posts/search/*","/api/v1/community/posts/*","/api/v1/community/posts/search/*/2","/api/v1/community/posts/search/my-post").permitAll()
