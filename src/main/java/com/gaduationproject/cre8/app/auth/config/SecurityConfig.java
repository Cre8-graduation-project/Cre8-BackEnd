                ...
                .authorizeHttpRequests((requests) ->
                        requests
                                ...
                                ,"/api/v1/employee-posts/search","/api/v1/employer/posts/*","/api/v1/employer-posts/search","/api/v1/members/check",
                                        ...
                                        "/api/v1/employer-posts/search/keyword","/api/v1/employee-posts/search/keyword","/api/v1/employee-posts/search/test","/api/v1/employee-posts/search/test2",
                                        "/api/v1/employee-posts/search/test3").permitAll()
