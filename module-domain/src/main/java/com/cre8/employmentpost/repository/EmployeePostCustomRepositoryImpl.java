...
import static com.cre8.employmentpost.entity.QEmployeePost.employeePost;
import static com.cre8.employmentpost.entity.QEmployeePostWorkFieldChildTag.employeePostWorkFieldChildTag;
import static com.cre8.workfieldtag.entity.QWorkFieldChildTag.workFieldChildTag;
import static com.cre8.workfieldtag.entity.QWorkFieldTag.workFieldTag;
import static com.querydsl.core.group.GroupBy.groupBy;
import static com.querydsl.core.group.GroupBy.list;


import com.cre8.employmentpost.dto.EmployeePostWorkFieldChildTagSearchDBResponseDto;
...
public class EmployeePostCustomRepositoryImpl implements EmployeePostCustomRepository{
    ...
    public Page<EmployeeSearchDBResponseDto> showEmployeePostDtoListWithPage(final EmployeePostSearch employeePostSearch,final Pageable pageable){
        ...
        List<Long> employeePostAfterWherePaging = queryFactory
                ...
                .leftJoin(employeePostWorkFieldChildTag.workFieldChildTag,workFieldChildTag)
                .leftJoin(employeePost.basicPostContent.workFieldTag,workFieldTag)
